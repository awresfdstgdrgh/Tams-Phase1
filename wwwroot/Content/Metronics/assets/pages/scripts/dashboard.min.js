var Dashboard = function () {
	return {
		initJQVMAP: function () {
			if (jQuery().vectorMap) {
				var e = function (e) { jQuery(".vmaps").hide(), jQuery("#vmap_" + e).show() }, t = function (e) {
					var t = jQuery("#vmap_" + e); if (1 === t.size()) {
						var a = {
							...
							onRegionOver: function (e, t) { "ca" == t && e.preventDefault() },
				...
				AmCharts.makeChart("dashboard_amchart_1",
					{
						...
						categoryAxis: {
							title:"Product Name",
							parseDates: !0, minPeriod: "DD",
							autoGridCount: !1,
							gridCount: 50,
							gridAlpha: .1, 
							gridColor: "#FFFFFF", axisColor: "#555555",
						...
						graphs: [{
							id: "g1", valueField: "distance", title: "Product Quantity", type: "column", fillAlphas: .7,
							valueAxis: "a1",							
							lineColor: "#08a3cc",
							alphaField: "alpha"
						}],
